...
public final class Flipkart {
	@Autowired
	@Qualifier("dtdc") //courier property has been injected with dtdc object or bean id, we can also configure the DTDC class with @Primary to inject  DTDC bean class object to courier property. 
